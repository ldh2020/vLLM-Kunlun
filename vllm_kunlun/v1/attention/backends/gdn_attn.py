...
class GDNAttentionMetadata:
    ...
    non_spec_state_indices_tensor_cpu: Optional[
        torch.Tensor] = None
...
class GDNAttentionMetadataBuilder(
    ...
    def build(  # type: ignore[override]
        ...
        attn_metadata = GDNAttentionMetadata(
            ...
            non_spec_state_indices_tensor_cpu=non_spec_state_indices_tensor.cpu() if non_spec_state_indices_tensor is not None else None,
